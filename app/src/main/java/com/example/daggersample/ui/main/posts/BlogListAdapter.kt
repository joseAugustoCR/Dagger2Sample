...
import kotlinx.android.synthetic.main.view_blogpost.view.*
import kotlinx.android.synthetic.main.view_post.view.title
...
class BlogListAdapter(private val interaction: Interaction? = null) :
    ...
    constructor(
        ...
        fun bind(item: BlogPost) = with(itemView) {
            ...
            Glide.with(itemView.context).load(item.image).fitCenter().into(img)
